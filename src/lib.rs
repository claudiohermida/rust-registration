...
mod tests {
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("BhDhXcHcmBDCKtDcEywBNey2Sk1hr7yjLLKxNoRa7amx").unwrap();
    ...
    fn transfer_all_sol() {
        ...
        // Create a test transaction to calculate fees, as a Message
    ...
    fn enroll() {
        ...
        let args = CompleteArgs {
            github: b"claudiohermida".to_vec(),
        };
